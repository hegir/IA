...
@Component({
  selector: 'app-obligated-discharged-report-admin',
  templateUrl: './obligated-discharged-report-admin.component.html',
...
export class ObligatedDischargedReportAdminComponent implements OnInit {
